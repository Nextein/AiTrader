...
All data related to a symbol should be stored in a single object for that symbol. The object should contain data according to the specified report JSON schema in app/models/report.json
