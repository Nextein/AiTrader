...
class BounceStrategyAgent(BaseAgent):
    ...
    async def handle_analysis_update(self, data: Dict[str, Any]):
        ...
        try:
            ...
            await analysis.update_section("bounce_strategy", {"analysis": analysis_entry}, timeframe)
            ...
            self.log_llm_call("bounce_strategy_analysis", symbol, {"signal": analysis_entry["signal"]})
