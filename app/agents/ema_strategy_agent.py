...
class EMAStrategyAgent(BaseAgent):
    ...
    async def handle_analysis_update(self, data: Dict[str, Any]):
        ...
        try:
            ...
            await analysis.update_section("ema_strategy", {"analysis": analysis_entry}, timeframe)
            ...
            self.log_llm_call("ema_strategy_analysis", symbol, {"signal": analysis_entry["signal"]})
