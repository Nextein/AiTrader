...
8. Event logs in the frontend should be made to be more beautiful and not just display the raw event data for each event. Market data events have already been made more beautiful, but the others have not.